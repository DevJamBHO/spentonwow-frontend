...
const Loading: React.FC = () => {
    useEffect(() => {
        const animateCalculator = (counter: number) => {
            ...
            const color2 = color.get(true, 0.88, 0.88) as string;
            const color1 = color.get(true, 0.90, 0.99) as string;
    ...
    return (
        <div className={styles.calcContainer}>
            <svg xmlns="http://www.w3.org/2000/svg" id="calc" className={styles.calc} clipRule="evenodd" fillRule="evenodd" imageRendering="optimizeQuality" shapeRendering="geometricPrecision" textRendering="geometricPrecision" viewBox="0 0 500 500" width="100" height="100">
                <defs>
                ...
                <g>
                    <path d="M100 30h300c11 0 20 9 20 20v400c0 11-9 20-20 20h-300c-11 0-20-9-20-20v-400c0-11 9-20 20-20z" fill="url(#a)" stroke="#434242" strokeWidth="10" />
                    <path id="screen" d="M120 60h260c6 0 10 4 10 10v60c0 6-4 10-10 10h-260c-6 0-10-4-10-10v-60c0-6 4-10 10-10z" fill="url(#b)" stroke="#434242" strokeWidth="10" />
